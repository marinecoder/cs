...
$sidebarLinks = Auth::getSidebarLinks();
?>

<aside class="fixed left-0 top-0 w-64 h-full bg-gray-900 text-white shadow-lg z-40">
    <!-- Logo -->
    <div class="p-6 border-b border-gray-700">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-xl font-bold">Courier Dash</h1>
    ...
    <div class="p-4 border-b border-gray-700">
        <div class="flex items-center">
            <div class="bg-gray-600 rounded-full w-10 h-10 flex items-center justify-center mr-3">
                <span class="text-sm font-medium"><?= strtoupper(substr($user['name'], 0, 2)) ?></span>
            </div>
            <div>
                <div class="font-medium"><?= htmlspecialchars($user['name']) ?></div>
                <div class="text-sm text-gray-400"><?= htmlspecialchars($user['role']) ?></div>
            </div>
        </div>
    </div>
    ...
    <nav class="mt-6">
        ...
        <ul class="space-y-1">
            <?php foreach($sidebarLinks as $link): ?>
                <?php 
                $isActive = strpos($_SERVER['REQUEST_URI'], $link['url']) === 0;
                $activeClass = $isActive ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white';
                ?>
                <li>
                    <a href="<?= $link['url'] ?>" 
                       class="<?= $activeClass ?> group flex items-center px-6 py-3 text-sm font-medium transition-colors duration-200">
                        ...
                        <svg class="mr-3 flex-shrink-0 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            $icons = [
                                ...
                                'users' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-7a4 4 0 11-8 0 4 4 0 018 0z"></path>',
                                'truck' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"></path>',
                                ...
                                'location-marker' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>',
                                ...
                                'support' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192L5.636 18.364M12 2.25a9.75 9.75 0 019.75 9.75c0 .896-.393 1.7-1.016 2.25"></path>',
                                ...
                                'document-report' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>',
                                'chart-pie' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>',
                                ...
                                'adjustments' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4"></path>'
                            ];
                            echo $icons[$link['icon']] ?? $icons['home'];
                            ?>
                        </svg>
    ...
    <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-700">
        <a href="/logout" 
           class="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg transition-colors duration-200">
